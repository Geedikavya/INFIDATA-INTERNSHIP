...
def info():
    ...
    sql = "insert into studentinfo(fname,l_name,email,gender,age,bday,address) values (%s,%s,%s,%s,%s,%s,%s)"
    val = (fname, l_name,email,gender,age,bday,address)
